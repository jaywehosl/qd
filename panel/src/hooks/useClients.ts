...
export type { ClientRecord, ClientTraffic, ClientDevice, ClientIpEntry, ClientsSummary, InboundOption };
...
export function useClients() {
  ...
  const summary = useMemo<ClientsSummary>(() => {
    ...
    const live = computeClientsSummary(allClientStats, new Set(onlines), expireDiff);
