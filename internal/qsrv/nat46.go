...
func (n *nat46) real(v4 netip.Addr) (netip.Addr, bool) {
...
func (n *nat46) forgetOldestLocked() {
...
func (n *Node) Stand(v6 netip.Addr) (netip.Addr, bool) { return n.nat.stand(v6) }
...
func (n *Node) stale(dst netip.AddrPort) bool {
	if !synthetic.Contains(dst.Addr()) {
		return false
	}
...
func (n *nat46) save(path string) error {
	n.mu.RLock()
...
func (n *nat46) dirty() bool { return n.marks.Swap(0) > 0 }
